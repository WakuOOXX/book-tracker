(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function n(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=n(a);fetch(a.href,r)}})();class ke{constructor(){this.routes=new Map,this.currentRoute=null,this.onNavigate=null,this._handleHashChange=this._handleHashChange.bind(this)}add(t,n){return this.routes.set(t,n),this}start(){window.addEventListener("hashchange",this._handleHashChange),this._handleHashChange()}_handleHashChange(){const t=window.location.hash.slice(1)||"home",{path:n,params:o}=this._match(t),a=this.routes.get(n);a&&(this.currentRoute={path:n,params:o,hash:t},a(o),this.onNavigate&&this.onNavigate(n,o))}_match(t){const n=t.split("/");for(const[o]of this.routes){const a=o.split("/");if(a.length!==n.length)continue;const r={};let l=!0;for(let i=0;i<a.length;i++)if(a[i].startsWith(":"))r[a[i].slice(1)]=n[i];else if(a[i]!==n[i]){l=!1;break}if(l)return{path:o,params:r}}return{path:"home",params:{}}}navigate(t){window.location.hash=t}destroy(){window.removeEventListener("hashchange",this._handleHashChange)}}const b=new ke;class Be{constructor(){this._state={books:[],readingLogs:[],filter:"all",searchQuery:"",sortBy:localStorage.getItem("book-sort")||"date-desc",currentBook:null,currentLog:null},this._listeners=new Map,this._idCounter=0}get state(){return this._state}setState(t,n){this._state[t]=n,this._notify(t,n)}on(t,n){return this._listeners.has(t)||this._listeners.set(t,new Set),this._listeners.get(t).add(n),()=>this._listeners.get(t).delete(n)}_notify(t,n){const o=this._listeners.get(t);o&&o.forEach(a=>a(n))}}const x=new Be,j=(e,t)=>t.some(n=>e instanceof n);let J,U;function De(){return J||(J=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function $e(){return U||(U=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const T=new WeakMap,R=new WeakMap,C=new WeakMap;function Le(e){const t=new Promise((n,o)=>{const a=()=>{e.removeEventListener("success",r),e.removeEventListener("error",l)},r=()=>{n(w(e.result)),a()},l=()=>{o(e.error),a()};e.addEventListener("success",r),e.addEventListener("error",l)});return C.set(t,e),t}function Se(e){if(T.has(e))return;const t=new Promise((n,o)=>{const a=()=>{e.removeEventListener("complete",r),e.removeEventListener("error",l),e.removeEventListener("abort",l)},r=()=>{n(),a()},l=()=>{o(e.error||new DOMException("AbortError","AbortError")),a()};e.addEventListener("complete",r),e.addEventListener("error",l),e.addEventListener("abort",l)});T.set(e,t)}let M={get(e,t,n){if(e instanceof IDBTransaction){if(t==="done")return T.get(e);if(t==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return w(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function ae(e){M=e(M)}function Ce(e){return $e().includes(e)?function(...t){return e.apply(L(this),t),w(this.request)}:function(...t){return w(e.apply(L(this),t))}}function _e(e){return typeof e=="function"?Ce(e):(e instanceof IDBTransaction&&Se(e),j(e,De())?new Proxy(e,M):e)}function w(e){if(e instanceof IDBRequest)return Le(e);if(R.has(e))return R.get(e);const t=_e(e);return t!==e&&(R.set(e,t),C.set(t,e)),t}const L=e=>C.get(e);function re(e,t,{blocked:n,upgrade:o,blocking:a,terminated:r}={}){const l=indexedDB.open(e,t),i=w(l);return o&&l.addEventListener("upgradeneeded",s=>{o(w(l.result),s.oldVersion,s.newVersion,w(l.transaction),s)}),n&&l.addEventListener("blocked",s=>n(s.oldVersion,s.newVersion,s)),i.then(s=>{r&&s.addEventListener("close",()=>r()),a&&s.addEventListener("versionchange",d=>a(d.oldVersion,d.newVersion,d))}).catch(()=>{}),i}function Ae(e,{blocked:t}={}){const n=indexedDB.deleteDatabase(e);return t&&n.addEventListener("blocked",o=>t(o.oldVersion,o)),w(n).then(()=>{})}const Re=["get","getKey","getAll","getAllKeys","count"],Pe=["put","add","delete","clear"],P=new Map;function Y(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(P.get(t))return P.get(t);const n=t.replace(/FromIndex$/,""),o=t!==n,a=Pe.includes(n);if(!(n in(o?IDBIndex:IDBObjectStore).prototype)||!(a||Re.includes(n)))return;const r=async function(l,...i){const s=this.transaction(l,a?"readwrite":"readonly");let d=s.store;return o&&(d=d.index(i.shift())),(await Promise.all([d[n](...i),a&&s.done]))[0]};return P.set(t,r),r}ae(e=>({...e,get:(t,n,o)=>Y(t,n)||e.get(t,n,o),has:(t,n)=>!!Y(t,n)||e.has(t,n)}));const Oe=["continue","continuePrimaryKey","advance"],G={},N=new WeakMap,se=new WeakMap,je={get(e,t){if(!Oe.includes(t))return e[t];let n=G[t];return n||(n=G[t]=function(...o){N.set(this,se.get(this)[t](...o))}),n}};async function*Te(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;const n=new Proxy(t,je);for(se.set(n,t),C.set(n,L(t));t;)yield n,t=await(N.get(n)||t.continue()),N.delete(n)}function Q(e,t){return t===Symbol.asyncIterator&&j(e,[IDBIndex,IDBObjectStore,IDBCursor])||t==="iterate"&&j(e,[IDBIndex,IDBObjectStore])}ae(e=>({...e,get(t,n,o){return Q(t,n)?Te:e.get(t,n,o)},has(t,n){return Q(t,n)||e.has(t,n)}}));const Me=Object.freeze(Object.defineProperty({__proto__:null,deleteDB:Ae,openDB:re,unwrap:L,wrap:w},Symbol.toStringTag,{value:"Module"})),Ne="book-tracker-db",Fe=1;let O=null;function y(){return O||(O=re(Ne,Fe,{upgrade(e){if(!e.objectStoreNames.contains("books")){const t=e.createObjectStore("books",{keyPath:"id",autoIncrement:!0});t.createIndex("title","title"),t.createIndex("author","author"),t.createIndex("category","category"),t.createIndex("status","status"),t.createIndex("createdAt","createdAt")}if(!e.objectStoreNames.contains("reading_logs")){const t=e.createObjectStore("reading_logs",{keyPath:"id",autoIncrement:!0});t.createIndex("bookId","bookId"),t.createIndex("round","round"),t.createIndex("startDate","startDate"),t.createIndex("endDate","endDate")}}})),O}async function D(){return(await y()).getAll("books")}async function S(e){return(await y()).get("books",e)}async function ie(e){const t=await y(),n=new Date().toISOString(),o={...e,createdAt:n,updatedAt:n},a=await t.add("books",o);return{...o,id:a}}async function de(e,t){const n=await y(),o=await n.get("books",e);if(!o)throw new Error(`Book ${e} not found`);const a={...o,...t,id:e,updatedAt:new Date().toISOString()};return await n.put("books",a),a}async function le(e){const t=await y();await t.delete("books",e);const n=await B(e),o=t.transaction("reading_logs","readwrite");await Promise.all(n.map(a=>o.store.delete(a.id))),await o.done}async function Ke(e){const t=await y(),n=t.transaction("books","readwrite");await Promise.all(e.map(o=>n.store.delete(o))),await n.done;for(const o of e){const a=await B(o),r=t.transaction("reading_logs","readwrite");await Promise.all(a.map(l=>r.store.delete(l.id))),await r.done}}async function He(e){const t=await D();if(!e)return t;const n=e.toLowerCase();return t.filter(o=>o.title&&o.title.toLowerCase().includes(n)||o.author&&o.author.toLowerCase().includes(n)||o.tags&&o.tags.some(a=>a.toLowerCase().includes(n)))}async function qe(e){return(await y()).getAllFromIndex("books","status",e)}async function B(e){return(await(await y()).getAllFromIndex("reading_logs","bookId",e)).sort((o,a)=>a.round-o.round)}async function ze(e){return(await y()).get("reading_logs",e)}async function ce(e){const t=await y(),n=new Date().toISOString(),o={...e,createdAt:n,updatedAt:n},a=await t.add("reading_logs",o);return{...o,id:a}}async function We(e,t){const n=await y(),o=await n.get("reading_logs",e);if(!o)throw new Error(`Log ${e} not found`);const a={...o,...t,id:e,updatedAt:new Date().toISOString()};return await n.put("reading_logs",a),a}async function ue(e){await(await y()).delete("reading_logs",e)}async function Ve(e){const t=await B(e);return t.length===0?0:Math.max(...t.map(n=>n.round||0))}async function ge(){const e=await D(),n=await(await y()).getAll("reading_logs");return{version:1,exportedAt:new Date().toISOString(),books:e,readingLogs:n}}async function me(e,t="merge"){if(!e.books||!e.readingLogs)throw new Error("Invalid data format");const n=await y();if(t==="overwrite"){const r=n.transaction("books","readwrite"),l=await r.store.getAll();await Promise.all(l.map(d=>r.store.delete(d.id))),await r.done;const i=n.transaction("reading_logs","readwrite"),s=await i.store.getAll();await Promise.all(s.map(d=>i.store.delete(d.id))),await i.done}const o=n.transaction("books","readwrite");for(const r of e.books)t==="merge"?r.id&&await n.get("books",r.id)||await o.store.add(r):await o.store.add(r);await o.done;const a=n.transaction("reading_logs","readwrite");for(const r of e.readingLogs)t==="merge"?r.id&&await n.get("reading_logs",r.id)||await a.store.add(r):await a.store.add(r);await a.done}async function Je(e){const n=(await Ue("reading_logs")).filter(o=>{const a=o.endDate||o.startDate;return a&&a.startsWith(String(e))});return{total:n.length,done:n.filter(o=>o.status==="done").length}}async function Ue(e){return(await y()).getAll(e)}const Ye=Object.freeze(Object.defineProperty({__proto__:null,addBook:ie,addReadingLog:ce,deleteBook:le,deleteBooks:Ke,deleteReadingLog:ue,exportAllData:ge,getAllBooks:D,getBook:S,getBooksByStatus:qe,getMaxRound:Ve,getReadingLog:ze,getReadingLogsByBook:B,getYearlyStats:Je,importAllData:me,searchBooks:He,updateBook:de,updateReadingLog:We},Symbol.toStringTag,{value:"Module"})),fe=[{hash:"home",label:"书架",icon:"📚"},{hash:"stats",label:"统计",icon:"📊"},{hash:"settings",label:"设置",icon:"⚙️"}];function pe(e,t){return e==="home"?t==="home"||t===""||(t==null?void 0:t.startsWith("book")):t===e}function be(){var t;const e=((t=b.currentRoute)==null?void 0:t.path)||"home";return`
      ...
      <div class="max-w-3xl mx-auto px-4">
        <div class="flex items-center justify-between h-14">
          ...
          <nav class="hidden md:flex gap-1">
            ${fe.map(n=>`<button
                class="nav-btn px-3 py-1.5 rounded-lg text-sm transition-all select-none ${pe(n.hash,e)?"bg-indigo-100 text-indigo-700 font-medium shadow-sm":"text-gray-500 hover:bg-gray-100"}"
                data-nav="${n.hash}"
  ...
  `}function ye(){var t;const e=((t=b.currentRoute)==null?void 0:t.path)||"home";return`
    <nav id="mobile-nav" class="md:hidden fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200 safe-area-bottom shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      <div class="flex items-center justify-around h-14 px-2">
        ${fe.map(n=>{const o=pe(n.hash,e);return`<button
  ...
  `}function we(){const e=document.getElementById("search-input"),t=document.getElementById("status-filter"),n=document.getElementById("sort-select");let o;e&&e.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{x.setState("searchQuery",e.value)},300)}),t&&t.addEventListener("change",()=>{x.setState("filter",t.value)}),n&&n.addEventListener("change",()=>{localStorage.setItem("book-sort",n.value),x.setState("sortBy",n.value)}),document.querySelectorAll("[data-book-id]").forEach(r=>{r.addEventListener("click",()=>{r.style.transform="scale(0.95)",setTimeout(()=>{b.navigate(`book/${r.dataset.bookId}`)},100)})});const a=document.getElementById("add-book-btn");a&&a.addEventListener("click",()=>{var r;(r=document.getElementById("add-book-btn"))==null||r.classList.add("scale-90"),setTimeout(()=>{b.navigate("book/new")},100)})}function $(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}const nt="modulepreload",ot=function(e,t){return new URL(e,t).href},X={},q=function(t,n,o){let a=Promise.resolve();if(n&&n.length>0){const l=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),s=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));a=Promise.allSettled(n.map(d=>{if(d=ot(d,o),d in X)return;X[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(!!o)for(let p=l.length-1;p>=0;p--){const h=l[p];if(h.href===d&&(!c||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":nt,c||(g.as="script"),g.crossOrigin="",g.href=d,s&&g.setAttribute("nonce",s),document.head.appendChild(g),c)return new Promise((p,h)=>{g.addEventListener("load",p),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(l){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=l,window.dispatchEvent(i),!i.defaultPrevented)throw l}return a.then(l=>{for(const i of l||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};function at(){const e=E||[],t=xe(),n=e.filter(s=>s.status==="done"),o=n.length,a=n.filter(s=>s.rating).length?(n.filter(s=>s.rating).reduce((s,d)=>s+d.rating,0)/n.filter(s=>s.rating).length).toFixed(1):"—",r={};e.forEach(s=>{r[s.category||"其他"]=(r[s.category||"其他"]||0)+1});const l=Object.entries(r).sort((s,d)=>d[1]-s[1]),i=Array(12).fill(0);return n.forEach(s=>{(F[s.id]||[]).filter(c=>c.status==="done"&&c.endDate).forEach(c=>{const u=new Date(c.endDate).getMonth();new Date(c.endDate).getFullYear()===t&&i[u]++})}),e.filter(s=>s.status==="wish").length,e.filter(s=>s.status==="reading").length,`
    <div class="page-enter max-w-3xl mx-auto px-4 py-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                <div class="w-32 bg-gray-100 rounded-full h-2">
                  <div class="bg-indigo-500 h-2 rounded-full" style="width: ${(d/e.length*100).toFixed(0)}%"></div>
                </div>
                <span class="text-xs text-gray-500 w-6 text-right">${d}</span>
              </div>
            </div>
          `).join("")}
        </div>
  ...
  `}let E=null,F={};async function rt(){E=await D();const e=Array(12).fill(0),t=E.filter(s=>s.status==="done"),n=xe(),o=[];for(const s of E){const d=await B(s.id);F[s.id]=d,o.push(...d)}t.forEach(s=>{(F[s.id]||[]).filter(c=>c.status==="done"&&c.endDate).forEach(c=>{const u=new Date(c.endDate).getMonth();new Date(c.endDate).getFullYear()===n&&e[u]++})});const a=(await q(async()=>{const{default:s}=await import("./chart-CnQqxsCx.js");return{default:s}},[],import.meta.url)).default,r=document.getElementById("monthly-chart");r&&new a(r,{type:"line",data:{labels:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],datasets:[{label:"读完数",data:e,borderColor:"#4f46e5",backgroundColor:"rgba(79,70,229,0.1)",fill:!0,tension:.3,pointRadius:3}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1}}}}});const l=document.getElementById("category-chart");if(l){const s={};E.forEach(u=>{s[u.category||"其他"]=(s[u.category||"其他"]||0)+1});const d=Object.entries(s),c=["#4f46e5","#f59e0b","#10b981","#ef4444","#8b5cf6","#ec4899","#14b8a6","#f97316","#6366f1"];new a(l,{type:"doughnut",data:{labels:d.map(u=>u[0]),datasets:[{data:d.map(u=>u[1]),backgroundColor:c.slice(0,d.length)}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{boxWidth:10,padding:8,font:{size:10}}}}}})}const i=document.getElementById("status-chart");if(i){const s=E.filter(u=>u.status==="wish").length,d=E.filter(u=>u.status==="reading").length,c=E.filter(u=>u.status==="done").length;new a(i,{type:"doughnut",data:{labels:["想读","在读","已读"],datasets:[{data:[s,d,c],backgroundColor:["#f59e0b","#3b82f6","#10b981"]}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"bottom",labels:{boxWidth:10,padding:8,font:{size:10}}}}}})}}function m(e,t="info",n=3e3){const o={info:"bg-blue-500",success:"bg-green-500",warning:"bg-amber-500",error:"bg-red-500"},a=document.createElement("div");a.className=`toast-enter fixed top-4 right-4 z-50 px-4 py-3 rounded-lg text-white text-sm shadow-lg ${o[t]||o.info} max-w-xs`,a.textContent=e,document.body.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transition="opacity 0.3s",setTimeout(()=>a.remove(),300)},n)}function z(){try{const e=localStorage.getItem("ocr-config");return e?JSON.parse(e):null}catch{return null}}async function st(e){const t=z();if(!t||!t.apiKey||!t.secretKey)throw new Error("请先在设置中配置 OCR API");t.provider;const n=await fetch("https://ocr.cn-shanghai.aliyuncs.com/",{method:"POST",headers:{"Content-Type":"application/json",Authorization:t.apiKey,"x-ocr-secret":t.secretKey},body:JSON.stringify({image:e,type:"General"})});if(!n.ok)throw new Error(`阿里云 OCR 请求失败: ${n.status}`);const o=await n.json();return it(o)}function it(e){var o;const t=((o=e==null?void 0:e.data)==null?void 0:o.content)||(e==null?void 0:e.content)||[],n=Array.isArray(t)?t.join(`
`):typeof t=="string"?t:"";return Ee(n)}async function dt(e){const t=z();if(!t||!t.apiKey||!t.secretKey)throw new Error("请先在设置中配置 OCR API");const n=await fetch(`https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id=${t.apiKey}&client_secret=${t.secretKey}`,{method:"POST"});if(!n.ok)throw new Error("百度 token 获取失败");const o=await n.json(),a=o.access_token;if(!a)throw new Error("百度 token 无效: "+JSON.stringify(o));const r=new URLSearchParams;r.append("image",e),r.append("detect_direction","true");const l=await fetch(`https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=${a}`,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:r.toString()});if(!l.ok){const s=await l.text();throw new Error(`百度 OCR 请求失败: ${l.status} - ${s}`)}const i=await l.json();return lt(i)}function lt(e){if(e.error_msg)throw new Error(`百度 OCR 错误: ${e.error_msg}`);const n=(e.words_result||[]).map(o=>o.words).filter(Boolean).join(`
`);return Ee(n)}function Ee(e){if(!e||!e.trim())return null;const t=e.split(`
`).filter(l=>l.trim()),n=e.trim(),o=[];for(const l of t){const i=l.trim();if(i.length<2)continue;let s="",d="";const c=i.match(/《([^》]+)》\s*(著|编著|主编|编)?\s*[：: ]?\s*(.+)?/);if(c){s=c[1].trim(),d=(c[3]||"").trim(),o.push({title:s,author:d});continue}const u=i.match(/^(.+?)\s*[／/｜|—–—-]\s*(.+)$/);if(u&&(s=u[1].trim(),d=u[2].trim(),s.length<50&&!s.includes("第")&&!s.includes("页"))){o.push({title:s,author:d});continue}const f=i.match(/^(.+?)\s+(著|编著|主编|编|译|著者|作者)[：: ]\s*(.+)$/);if(f){s=f[1].trim(),d=f[3].trim(),o.push({title:s,author:d});continue}const g=i.match(/(?:ISBN[：: ]*)?((?:\d[-\s]?){10,13})/);if(g){g[1].replace(/[-\s]/g,"");continue}i.length>=2&&i.length<=50&&!i.startsWith("第")&&!i.startsWith("页")&&!/^\d+$/.test(i)&&!i.includes("http")&&o.push({title:i,author:""})}const a=new Set,r=o.filter(l=>{const i=l.title;return a.has(i)?!1:(a.add(i),!0)});return r.length===0?n.length<=60?{title:n,author:""}:null:r}async function ct(e){const t=z();if(!t||!t.apiKey||!t.secretKey)throw new Error("请先在设置页面配置 OCR API Key");let n;return t.provider==="baidu"?n=await dt(e):n=await st(e),n&&!Array.isArray(n)?[n]:n||[]}function ut(e){return new Promise((t,n)=>{const o=new FileReader;o.onload=()=>{const a=o.result.split(",")[1]||o.result;t(a)},o.onerror=()=>n(new Error("图片读取失败")),o.readAsDataURL(e)})}function ee(e,t=1024,n=.85){return new Promise(o=>{const a=new Image;a.onload=()=>{const r=document.createElement("canvas");let l=a.width,i=a.height;l>t&&(i=i*t/l,l=t),r.width=l,r.height=i,r.getContext("2d").drawImage(a,0,0,l,i),o(r.toDataURL("image/jpeg",n).split(",")[1])},a.src="data:image/jpeg;base64,"+e})}function te(e){return(e!=null&&e.id?parseInt(e.id):null)?'<div class="page-enter max-w-3xl mx-auto px-4 py-4"><p class="text-center text-gray-400">加载中...</p></div>':`
    <div class="page-enter max-w-3xl mx-auto px-4 py-4">
  ...
  `}function ne(e){const t=e!=null&&e.id?parseInt(e.id):null,n=!!t,o=document.getElementById("form-back-btn");o&&o.addEventListener("click",()=>window.history.back()),document.querySelectorAll(".rating-star").forEach(d=>{d.addEventListener("click",()=>{const c=parseInt(d.dataset.rating);document.getElementById("field-rating").value=c,document.querySelectorAll(".rating-star").forEach((u,f)=>{u.classList.toggle("text-amber-400",f<c),u.classList.toggle("text-gray-300",f>=c)})})});const a=document.getElementById("ocr-camera");a&&a.addEventListener("click",async()=>{try{const d=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),c=document.createElement("video");c.srcObject=d,c.setAttribute("playsinline",""),c.setAttribute("autoplay",""),c.style.cssText="position:fixed;top:-9999px;left:-9999px;width:1px;height:1px",document.body.appendChild(c),await new Promise(g=>{c.onloadedmetadata=g});const u=document.getElementById("ocr-preview"),f=document.getElementById("ocr-status");u.classList.remove("hidden"),f.textContent="📸 请对准书籍拍照...",a.textContent="📷 拍照",a.onclick=()=>{const g=document.createElement("canvas");g.width=c.videoWidth,g.height=c.videoHeight,g.getContext("2d").drawImage(c,0,0),g.toBlob(async p=>{d.getTracks().forEach(h=>h.stop()),c.remove(),f.textContent="🔄 识别中...",a.textContent="📸 拍照",a.onclick=null,await i(p)},"image/jpeg",.85)}}catch(d){d.name==="NotAllowedError"?m("请允许使用摄像头权限","warning"):d.name==="NotFoundError"?m("未检测到摄像头","warning"):m("拍照启动失败: "+d.message,"error")}});const r=document.getElementById("ocr-gallery");r&&r.addEventListener("click",()=>{const d=document.createElement("input");d.type="file",d.accept="image/*",d.multiple=!0,d.onchange=async c=>{const u=Array.from(c.target.files);if(u.length===0)return;const f=document.getElementById("ocr-preview"),g=document.getElementById("ocr-status");f.classList.remove("hidden");for(let p=0;p<u.length;p++)g.textContent=`🔄 正在识别第 ${p+1}/${u.length} 张...`,await i(u[p],p>0);g.textContent="✅ 识别完成"},d.click()});const l=document.getElementById("ocr-paste");l&&l.addEventListener("click",async()=>{try{const d=await navigator.clipboard.read();let c=!1;for(const u of d){const f=u.types.find(g=>g.startsWith("image/"));if(f){const g=await u.getType(f),p=document.getElementById("ocr-preview"),h=document.getElementById("ocr-status");p.classList.remove("hidden"),h.textContent="🔄 识别中...",await i(g),h.textContent="✅ 识别完成",c=!0;break}}c||m("剪贴板中没有图片，请先截图再粘贴","warning")}catch(d){d.name==="NotAllowedError"?m("请允许剪贴板读取权限","warning"):m("粘贴读取失败: "+d.message,"error")}});async function i(d,c=!1){try{const u=await ut(d),f=await ee(u),g=await ct(f);if(!g||g.length===0){m("未识别出书籍信息，请手动输入","warning");return}const p=document.getElementById("ocr-results");c||(p.innerHTML="");let h="";for(const v of g){if(!v.title)continue;const V=v.title?Ze(v.title,v.author):"其他";h||(h=v.title,document.getElementById("field-title").value=v.title||"",document.getElementById("field-author").value=v.author||"",document.getElementById("field-category").value=V);const A=document.createElement("div");A.className="flex items-center justify-between bg-gray-50 rounded-lg px-3 py-2 text-sm",A.innerHTML=`
          <div>
        ...
        `,p.appendChild(A)}const _=document.createElement("img");_.src="data:image/jpeg;base64,"+await ee(u,200,.6),_.className="w-full rounded-lg mt-2 max-h-32 object-contain bg-gray-50",p.appendChild(_)}catch(u){throw m("OCR 识别失败: "+u.message,"error"),u}}const s=document.getElementById("book-form");s&&s.addEventListener("submit",async d=>{d.preventDefault();const c=document.getElementById("field-title").value.trim(),u=document.getElementById("field-author").value.trim();if(!c||!u){m("请填写书名和作者","warning");return}const f={title:c,author:u,isbn:document.getElementById("field-isbn").value.trim(),category:document.getElementById("field-category").value,status:document.getElementById("field-status").value,totalPages:parseInt(document.getElementById("field-pages").value)||0,rating:parseInt(document.getElementById("field-rating").value)||0,review:document.getElementById("field-review").value.trim(),pagesRead:0,tags:[]};try{if(n)await de(t,f),m("更新成功","success"),b.navigate(`book/${t}`);else{const g=await ie(f);if(f.status!=="wish"){const{addReadingLog:p}=await q(async()=>{const{addReadingLog:h}=await Promise.resolve().then(()=>Ye);return{addReadingLog:h}},void 0,import.meta.url);await p({bookId:g.id,round:1,status:f.status,startDate:new Date().toISOString(),endDate:f.status==="done"?new Date().toISOString():null,progress:0,rating:f.rating,review:f.review,notes:""})}m("添加成功","success")}b.navigate("home")}catch(g){m("保存失败: "+g.message,"error")}})}async function gt(e){const t=await S(e);if(!t){m("书籍不存在","error"),b.navigate("home");return}document.getElementById("field-title").value=t.title||"",document.getElementById("field-author").value=t.author||"",document.getElementById("field-isbn").value=t.isbn||"",document.getElementById("field-category").value=t.category||"其他",document.getElementById("field-status").value=t.status||"wish",document.getElementById("field-pages").value=t.totalPages||"",t.rating&&(document.getElementById("field-rating").value=t.rating,document.querySelectorAll(".rating-star").forEach((n,o)=>{n.classList.toggle("text-amber-400",o<t.rating),n.classList.toggle("text-gray-300",o>=t.rating)})),document.getElementById("field-review").value=t.review||""}function mt(e){return'<div class="page-enter max-w-3xl mx-auto px-4 py-4"><p class="text-center text-gray-400">加载中...</p></div>'}async function ft(e){const t=e!=null&&e.id?parseInt(e.id):null;if(!t){m("无效的书籍ID","error"),b.navigate("home");return}const n=await S(t);if(!n){m("书籍不存在","error"),b.navigate("home");return}const o=await B(t);document.querySelector("#page-content")||document.querySelector("#app-content");const a=()=>{const r=document.querySelector("#app-content");r&&(r.innerHTML=`
      <div class="page-enter max-w-3xl mx-auto px-4 py-4">
        <!-- Header -->
        <div class="flex items-center gap-3 mb-4">
  ...
  `}function bt(e,t){var r,l,i;const o=(t.length>0?Math.max(...t.map(s=>s.round||0)):0)+1,a=document.createElement("div");a.className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center",a.innerHTML=`
  ...
  `,document.body.appendChild(a),(r=document.getElementById("log-status"))==null||r.addEventListener("change",s=>{document.getElementById("end-date-group").style.display=s.target.value==="done"?"block":"none"}),document.getElementById("end-date-group").style.display="none",document.getElementById("log-start").value=new Date().toISOString().split("T")[0],(l=document.getElementById("log-form-cancel"))==null||l.addEventListener("click",()=>a.remove()),a.addEventListener("click",s=>{s.target===a&&a.remove()}),(i=document.getElementById("new-log-form"))==null||i.addEventListener("submit",async s=>{s.preventDefault();const d={bookId:e,round:o,status:document.getElementById("log-status").value,startDate:document.getElementById("log-start").value?new Date(document.getElementById("log-start").value).toISOString():new Date().toISOString(),endDate:document.getElementById("log-status").value==="done"&&document.getElementById("log-end").value?new Date(document.getElementById("log-end").value).toISOString():null,rating:parseInt(document.getElementById("log-rating").value)||0,review:document.getElementById("log-review").value.trim(),progress:parseInt(document.getElementById("log-progress").value)||0,notes:""};try{await ce(d),m("添加成功","success"),a.remove(),window._detailRefresh&&window._detailRefresh()}catch(c){m("保存失败: "+c.message,"error")}})}function Ie(e){return{wish:"bg-amber-100 text-amber-800",reading:"bg-blue-100 text-blue-800",done:"bg-green-100 text-green-800"}[e]||"bg-gray-100 text-gray-800"}function yt(){return`
    <div class="page-enter max-w-3xl mx-auto px-4 py-4">
  ...
  `}function ht(){var t,n,o,a;const e=localStorage.getItem("ocr-config");if(e)try{const r=JSON.parse(e);document.getElementById("ocr-provider").value=r.provider||"aliyun",document.getElementById("ocr-api-key").value=r.apiKey||"",document.getElementById("ocr-secret-key").value=r.secretKey||""}catch{}(t=document.getElementById("save-ocr-config"))==null||t.addEventListener("click",()=>{const r={provider:document.getElementById("ocr-provider").value,apiKey:document.getElementById("ocr-api-key").value.trim(),secretKey:document.getElementById("ocr-secret-key").value.trim()};if(!r.apiKey||!r.secretKey){m("请填写 API Key 和 Secret Key","warning");return}localStorage.setItem("ocr-config",JSON.stringify(r)),m("配置已保存","success")}),(n=document.getElementById("export-data-btn"))==null||n.addEventListener("click",async()=>{try{const r=await ge(),l=new Blob([JSON.stringify(r,null,2)],{type:"application/json"}),i=URL.createObjectURL(l),s=document.createElement("a");s.href=i,s.download="book-tracker-backup-"+new Date().toISOString().split("T")[0]+".json",s.click(),URL.revokeObjectURL(i),m("数据已导出","success")}catch(r){m("导出失败: "+r.message,"error")}}),(o=document.getElementById("import-data-input"))==null||o.addEventListener("change",async r=>{const l=r.target.files[0];if(l){try{const i=await l.text(),s=JSON.parse(i),d=confirm(`确定要导入吗？
取消 = 合并（跳过已存在的记录）
确定 = 覆盖（清除现有数据后再导入）`)?"overwrite":"merge";await me(s,d),m("数据已"+(d==="overwrite"?"覆盖":"合并")+"导入，请刷新页面","success")}catch(i){m("导入失败: "+i.message,"error")}r.target.value=""}}),(a=document.getElementById("clear-data-btn"))==null||a.addEventListener("click",async()=>{if(!(prompt("输入 DELETE 确认清除所有数据：")!=="DELETE"||!confirm("最后一次确认！清除后数据无法恢复！")))try{const{openDB:i}=await q(async()=>{const{openDB:g}=await Promise.resolve().then(()=>Me);return{openDB:g}},void 0,import.meta.url),s=await i("book-tracker-db",1),d=s.transaction("books","readwrite"),c=await d.store.getAll();await Promise.all(c.map(g=>d.store.delete(g.id))),await d.done;const u=s.transaction("reading_logs","readwrite"),f=await u.store.getAll();await Promise.all(f.map(g=>u.store.delete(g.id))),await u.done,m("所有数据已清除","success"),location.reload()}catch(i){m("清除失败: "+i.message,"error")}})}const xt=document.getElementById("app");xt.innerHTML=`
...
`;he();function k(e){const t=document.getElementById("app-content");t&&(t.innerHTML=e)}function W(){k(ve()),we()}x.on("filter",()=>{var e;((e=b.currentRoute)==null?void 0:e.path)==="home"&&W()});x.on("searchQuery",()=>{var e;((e=b.currentRoute)==null?void 0:e.path)==="home"&&W()});x.on("sortBy",()=>{var e;((e=b.currentRoute)==null?void 0:e.path)==="home"&&W()});async function vt(){try{const e=await D();x.setState("books",e)}catch(e){console.error("Failed to load data:",e)}}b.add("home",async()=>{await vt(),k(ve()),we()}).add("stats",async()=>{k(at()),await rt()}).add("book/new",async()=>{k(te({})),ne({})}).add("book/:id/edit",async e=>{const t=parseInt(e.id);k(te({id:t})),ne({id:t}),t&&await gt(t)}).add("book/:id",async e=>{k(mt()),await ft(e)}).add("settings",async()=>{k(yt()),ht()});document.addEventListener("paste",e=>{var t,n,o,a;if(((t=b.currentRoute)==null?void 0:t.path)==="book/new"||(o=(n=b.currentRoute)==null?void 0:n.path)!=null&&o.startsWith("book/")){const r=(a=e.clipboardData)==null?void 0:a.items;if(r){for(const l of r)if(l.type.startsWith("image/")){m("截图粘贴将在 Phase 4 实现","info");break}}}});b.start();
